  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-6">
        <h1 className="text-xl font-comic text-black mb-6 inline-block bg-yellow-400 border-2 border-black px-4 py-2 shadow-[2px_2px_0px_0px_#000] -rotate-1 uppercase">
          Términos y Condiciones
        </h1>
      </div>

      <div className="bg-white border-2 border-black rounded-xl p-4 comic-shadow space-y-8 font-bold text-gray-800">
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-red-500">
            <Scale className="w-8 h-8" />
            <h2 className="text-lg font-comic text-black uppercase">1. Ámbito de Aplicación</h2>
          </div>
          <p>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-cyan-500">
            ...
            <h2 className="text-lg font-comic text-black uppercase">2. Participación y Registro</h2>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-yellow-500">
            ...
            <h2 className="text-lg font-comic text-black uppercase">3. Mecánica de Sorteos</h2>
          </div>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-comic text-black uppercase">4. Pagos y Reembolsos</h2>
          <p>
